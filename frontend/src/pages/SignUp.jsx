    ...
    >
      <form
        className="w-[90%] h-[600px] max-w-[500px] bg-[#0000003d] backdrop-blur shadow-lg shadow-black 
                   p-6 rounded-lg flex flex-col items-center justify-center gap-2"
      ...
      >
        ...
        <input
          ...
          className='w-full h-[60px] outline-none px-[20px] py-[10px] border-2 text-white 
                     placeholder-gray-300 rounded-full text-lg'
          required
          value={name}
        ...
        <input
          ...
          className='mt-3 w-full h-[60px] outline-none px-[20px] py-[10px] border-2 text-white 
                     placeholder-gray-300 rounded-full text-lg'
        />
        ...
        {err.length > 0 && (
          <p className="text-red-500 text-[12px] mt-1">*{err}</p>
        )}
